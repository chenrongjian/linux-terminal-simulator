...
export const metadata: Metadata = {
  ...
  description: '一个基于 Next.js 和 AI 的 Web 端 Linux 终端模拟器，支持常用 Linux 命令和趣味 ASCII 艺术生成。包含 cowsay 命令生成可爱的 Tux 企鹅字符画，提供实时响应和格式化输出。适合学习和体验 Linux 命令行操作。',
  keywords: 'Linux, 终端模拟器, 命令行, Web 终端, Linux 学习, Next.js, AI, cowsay, ASCII art, Tux, 企鹅字符画',
  authors: [{ name: 'chenrongjian' }],
  openGraph: {
    title: 'Linux 终端模拟器 | 在线体验 Linux 命令和趣味 ASCII 艺术',
    description: '一个基于 Next.js 和 AI 的 Web 端 Linux 终端模拟器，支持常用 Linux 命令和趣味 ASCII 艺术生成。特色功能包括 cowsay 命令生成可爱的 Tux 企鹅字符画。',
    type: 'website',
    locale: 'zh_CN',
